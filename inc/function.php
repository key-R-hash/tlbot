...
if($massage == '-finish_login-'){
    ...
    if($posts == null && $login == 1){
        ...
        $query = $connection->query($query_str); 
        $url = "https://api.telegram.org/bot734973442:AAG-xo0OWhcPhrJGNX1fBrNvmq2D4G0KVN8/sendmessage?chat_id=".$chatId."&text=your username or password incorrect inter your username and password again";
        file_get_contents($url);
        die();
    }
}
